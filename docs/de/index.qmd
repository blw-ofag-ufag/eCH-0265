...
abstract: |
  Dieses Hilfsmittel beschreibt ein Datenmodell zu landwirtschaftlichen Kulturen der Schweiz sowie die dazugehörenden Referenzobjekte, welche als maschinenlesbare Linked Data bezogen werden können.
  In der vorliegenden Version bildet es die Beziehungen zwischen landwirtschaftlichen Kulturen aus den Bereichen Direktzahlungen, Nährstoffbilanz und Pflanzenschutz ab.
  Dabei wird nicht nur das Datenmodell zur Verfügung gestellt, sondern auch die effektiven Daten -- inklusive Mapping-Tabellen, um den Bezug zwischen den unterschiedlichen Bereichen herzustellen.
  Damit soll ein fachlich validierter Datenaustausch und die Mehrfachnutzung von Daten ermöglicht werden.
date: today
date-format: long
lang: de-CH
---
