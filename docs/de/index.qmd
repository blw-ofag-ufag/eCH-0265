...
Um umweltbelastende Nährstoffverluste zu verhindern und die Ertragsfähigkeit der Böden nachhaltig zu sichern, müssen Schweizer Landwirtschaftsbetriebe eine ausgeglichene Nährstoffbilanz ausweisen [@grud2017]. Das zentrale Berechnungsinstrument hierfür ist die Suisse-Bilanz, welche den Nährstoffanfall (etwa durch Hofdünger) und den Nährstoffbedarf auf Betriebsebene systematisch gegenüberstellt [@suibi2025]. Für diese Bilanzierung wurden spezifische Kulturen definiert, weil jede landwirtschaftliche Kultur einen anderen, normierten Nährstoffbedarf (z.B. für Stickstoff oder Phosphor) aufweisen [@grud2017]. Die Zuweisung dieser Kulturen ist die Grundvoraussetzung, um eine Nährstoffbilanz für einen Betrieb berechnen zu können.

Um die Suisse-Bilanz zu rechnen, ist die "Wegleitung Suisse-Bilanz" entscheidend, welche von Agridea und dem Bundesamt für Landwirtschaft herausgegeben wird [@suibi2025]. In dem Dokument sind viele Referenztabellen enthalten, die entsprechend nach Kulturen aufgegliedert sind, abgeleitet von den detaillierteren Tabellen in @grud2017.

## Kulturen im Pflanzenschutzmittelverzeichnis

Dieses System umfasst 321 Kulturen, welche im Gegensatz zu GRUD eine flexible Polyhierarchie aufweisen. Eine Kultur kann zwei direkte Übergruppen besitzen (z. B. gehört Sommergerste sowohl zur Übergruppe "Gerste" als auch zu "Sommergetreide"). Die genaue Abbildung dieser Hierarchie ist von Bedeutung, da eine bewilligte Pflanzenschutz-Anwendung auf einer Übergruppe automatisch auch auf all deren Untergruppen bewilligt ist.

Beispiel: Das Herbizid "Ariane C" ist gegen ein- und mehrjährige Dicotyledonen in Getreiden einsetzbar. Damit ist es automatisch bei allen Kulturen einsetzbar, welche vom Pflanzenschutzmittelverzeichnis als Getreide gesehen werden. Zum Beispiel gehört Mais explizit nicht dazu.

## Nutzung von Semantic-Web-Technologien

Im Gegensatz zum Pflanzenschutzmittelverzeichnis wird beim Nährstoffbilanzrechner Mais als Getreide gezählt – es existieren also verschiedene Definitionen von Getreide. Um diese eindeutig kennzeichnen zu können, setzen wir auf Linked Data. Jede Definition bekommt eine URI (in unserem Fall als URL dereferenzierbar). Die hier beschriebene Datensammlung beschreibt die Beziehungen der Klassen.
