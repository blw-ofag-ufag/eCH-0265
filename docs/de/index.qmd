...
abstract: |
  ...
  Dabei wird nicht nur ein Datenmodell zur Verfügung gestellt, sondern auch die dazugehörigen Daten -- inklusive Mapping-Tabellen, um den Bezug zwischen Kulturen unterschiedlicher Bereiche herzustellen.
...
Der Begriff der landwirtschaftlichen Kultur stützt sich in diesem Hilfsmittel massgeblich auf das Konzept des `CultivationType` aus der Vorversion (eCH-0265, Version 1.0.0).
...
Das Pflanzenschutzmittelverzeichnis (PSMV) ist das offizielle Register des Bundes, das alle in der Schweiz zugelassenen Pflanzenschutzmittel auflistet und verbindlich regelt, für welche Kulturen und unter welchen Bedingungen diese rechtmässig eingesetzt werden dürfen.
...
Eine Kultur kann dabei bis zu zwei direkte Übergruppen besitzen. So ist beispielsweise die *Sommergerste* sowohl der Übergruppe «Gerste» als auch dem «Sommergetreide» untergeordnet.
