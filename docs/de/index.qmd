...
abstract: |
  ...
  In dieser Version bildet das Hilfsmittel die Beziehungen zwischen landwirtschaftlichen Kulturen aus den Bereichen Direktzahlungen, Nährstoffbilanz und dem Pflanzenschutzmittelverzeichnis ab.
  Dabei wird nicht nur ein Datenmodell zu Verfügung gestellt, sondern auch die dazugehörigen Daten -- inklusive Mapping-Tabellen, um den Bezug zwischen Kulturen unterschiedlicher Bereiche herzustellen.
...
Der NBBS ordnet die Kulturen in einer strikten, dreistufigen Hierarchie:
...
: Hierarchische Struktur der Kulturen im NBBS {#tbl-nbbs-hierarchie}
...
Die Version 1.1.0 umfasst primär redaktionelle Anpassungen sowie die Aktualisierung von Referen-zen. Die wesentlichen Änderungen gegenüber der Version 1.0.0 sind:

-	Einführung des neuen, optionalen Datentyps agriculturalRegionType
-	Die Verweise auf externe Listen wurden aktualisiert und verweisen nun auf die Interoperabilitäts-plattform des Bundes (i14y.admin.ch) anstelle der allgemeinen BLW-Webseite.
-	Anpassung des Namens der Fachgruppe auf "AgriFood".
